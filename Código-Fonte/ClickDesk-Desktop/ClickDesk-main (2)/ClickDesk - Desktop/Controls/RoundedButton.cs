...
{
    /// <summary>
    /// Botão personalizado com bordas arredondadas, efeitos hover/click e estilo moderno.
    ...
    public class RoundedButton : Button
    {
        ...
        [Category("Appearance")]
        [Description("Raio das bordas arredondadas em pixels")]
        ...
        [Category("Appearance")]
        [Description("Cor ao passar o mouse (hover)")]
        ...
        public RoundedButton()
        {
            ...
            // Cores padrão do StyleManager
            BackColor = StyleManager.Colors.Primary;
            ForeColor = StyleManager.Colors.TextInverted;
            Font = StyleManager.Fonts.Button;
            
            _normalColor = BackColor;
            _hoverColor = StyleManager.Colors.PrimaryDark;
            _clickColor = StyleManager.Colors.PrimaryDark;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            // Desenhar borda ao ter foco
            if (Focused)
            {
                using (Pen focusPen = new Pen(StyleManager.Colors.FocusColor, 2))
                {
